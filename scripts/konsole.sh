...
curl -Lo "$rice_directory/configs/konsole-catppuccin-mocha.colorscheme" https://raw.githubusercontent.com/catppuccin/konsole/refs/heads/main/themes/catppuccin-mocha.colorscheme
sudo rm -rf "$HOME/.local/share/konsole/catppuccin-mocha.colorscheme"
ln -sf "$rice_directory/configs/konsole-catppuccin-mocha.colorscheme" "$HOME/.local/share/konsole/catppuccin-mocha.colorscheme"
